...
@section('content')
<!-- Main content -->
<form action="{{url('/editProsesAdmin/' .$bpw->id_bpw) }}" method="post">
	@method('patch')
	{{csrf_field()}}

	<div class="form-group col-md-6">
    <label for="form_foto_user">Foto Pengguna</label>
    <input name="foto_user" type="file" class="form-control-file" id="input_foto_user" value ="{{$bpw -> foto_bpw}}">
	</div>
	<div class="form-group col-md-6">
    <label for="form_nm_user">Nama Pengguna</label>
   	<input name="nm_user" type="text" class="form-control" id="input_nm_user" value ="{{$bpw -> nm_bpw}}">
  </div>
  ...
  <div class="form-group col-md-6">
    ...
    <input name="nik" type="text" class="form-control" id="input_nik" value ="{{$bpw -> no_telp}}">
  </div>
  <div class="form-row col-md-6">
  	<div class="form-group col-md-6">
  ...
  <div class="form-row col-md-6">
    <div class="form-group col-md-6">
      ...
      <select name="jns_kelamin" class="form-control" id="input_jns_kelamin" value ="{{$bpw -> status}}">
    ...
    <div class="form-group col-md-6">
      ...
      <select name="level" class="form-control" id="input_level" value ="{{$bpw -> status}}">
        <option selected>-- Pilih Level --</option>
        <option value="1">Kepala Seksi Jasa</option>
  ...
  <div>
	  <button type="submit" class="btn btn-primary" style="margin-left: 15px; margin-top: 10px">Simpan Data Pengguna</button>
  </div>
</form>
@endsection
