...
@section('title', 'E-Report Biro Perjalanan Wisata | Kepala Seksi')
...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active treeview">
      ...
      <ul class="treeview-menu">
        <li class="active"><a href="/ereport_bpw"><i class="fa fa-circle-o"></i> Biro Perjalanan Wisata</a></li>
...
@section('content-title', 'E-Report Biro Perjalanan Wisata')
