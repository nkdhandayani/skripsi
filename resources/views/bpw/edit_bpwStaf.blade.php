...
@section('title', 'Edit Data Biro | Staf Jasa')
...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active treeview">
      ...
      <ul class="treeview-menu">
        <li class="active"><a href="{{url('list_bpwStaf')}}"><i class="fa fa-circle-o"></i> Data BPW</a></li>
...
@section('breadcrumb')
	...
	<li> Kelola BPW</li>
	<li><a href ="{{url('list_bpwStaf')}}"><span> Data BPW</span></a></li>
	<li class="active"> Edit Data Biro</li>
@endsection

@section('content')
<!-- Main content -->
<form action="{{url('/editProsesStaf/' .$bpw->id_bpw) }}" method="post">
	@method('patch')
	{{csrf_field()}}
...
<div>
	<button type="submit" class="btn btn-primary" style="margin-left: 15px; margin-top: 10px">Simpan Data BPW</button>
</div>
</form>
@endsection
